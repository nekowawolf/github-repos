...
const CommitMobileDropdown = ({ commitUrl, treeUrl }: { commitUrl: string, treeUrl: string }) => {
  ...
  return (
    <div className="relative sm:hidden" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute z-50 mt-1 w-max min-w-[210px] rounded-xl bg-[var(--card-color)] border border-[var(--border-divider)] shadow-xl animate-in fade-in zoom-in-95 duration-200 right-0 origin-top-right py-1">
          <a 
            href={commitUrl} 
            target="_blank" 
            rel="noreferrer" 
